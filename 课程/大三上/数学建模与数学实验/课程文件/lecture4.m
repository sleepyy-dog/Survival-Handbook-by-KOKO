...
% 主程序
t = 0:0.1:1;  % 设置时间范围从 0 到 1，步长为 0.1
...
% 绘制解析解与数值解的比较
figure;
plot(t, A(1,:), 'r', t, A(2,:), 'b--','LineWidth',2);  % 绘制解析解
hold on;
plot(t, x(:,1), 'g', t, x(:,2), 'k--','LineWidth',2);  % 绘制 ode23s 解
plot(t, y(:,1), 'm', t, y(:,2), 'c--','LineWidth',2);  % 绘制 ode23 解
legend('解析解 x1', '解析解 x2', 'ode23s 解 x1', 'ode23s 解 x2', 'ode23 解 x1', 'ode23 解 x2');
xlabel('时间 t');
ylabel('解值');
title('解析解与数值解的比较');
grid on;
