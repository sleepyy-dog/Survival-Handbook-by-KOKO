...
$$
\varlimsup_{n\to \infin}P[\{|Y_n|>B_{\delta}\}]<\delta
$$

$$
\varlimsup_{n\to \infin}P[|X_nY_n|>\varepsilon]\le\varlimsup_{n\to \infin}P[\{|X_nY_n|>\varepsilon\}\cap\{|Y_n|>B_{\delta}\}]+\varlimsup_{n\to \infin}P[\{|X_nY_n|>\varepsilon\}\cap\{|Y_n|\le B_{\delta}\}]\\
\le\varlimsup_{n\to \infin}P[\{|Y_n|>B_{\delta}\}]+\varlimsup_{n\to \infin}P[\{|X_n|>\varepsilon/B_{\delta}\}]\\
<\delta
$$
注意到我们可以有分布收敛到常数推出概率收敛，也就是有以下性质：
$$
\varlimsup_{n\to \infin}P[\{|X_n|>\varepsilon/B_{\delta}\}]=0
$$
此时我们令$\delta\to 0$,则知
$$
\varlimsup_{n\to \infin}P[|X_nY_n|>\varepsilon]=0
